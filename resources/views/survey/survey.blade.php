    ...
    <div id="main" class="center-block">
	    ...
	    <form name="suvery-form" id="survey-form" method="POST" action="/survey/saveResponse">
	        ...
	        <ul>
	            ...
	            <li>
	               <input type="radio" name="question[1]" value="2" id="cruz1">
	               <label for="cruz1">Ted Cruz</label>
	            </li>
	            <li>
	               <input type="radio" name="question[1]" value="3" id="kasich1"> 
                   <label for="kasich1">John Kasich</label>
                </li>
	            <li>
	               <input type="radio" name="question[1]" value="4" id="sanders1"> 
                   <label for="sanders1">Bernie Sanders</label>
                </li>
	            <li>
	        ...
	        <ul>
                ...
                <li>
                   <input type="radio" name="question[2]" value="2" id="cruz2">
                   <label for="cruz2">Ted Cruz</label>
                </li>
                <li>
                   <input type="radio" name="question[2]" value="3" id="kasich2"> 
                   <label for="kasich2">John Kasich</label>
                </li>
                <li>
                   <input type="radio" name="question[2]" value="4" id="sanders2"> 
                   <label for="sanders2">Bernie Sanders</label>
                </li>
                <li>
			...
			<ul>
                ...
                <li>
                   <input type="radio" name="question[3]" value="2" id="cruz3">
                   <label for="cruz3">Ted Cruz</label>
                </li>
                <li>
                   <input type="radio" name="question[3]" value="3" id="kasich3"> 
                   <label for="kasich3">John Kasich</label>
                </li>
                <li>
                   <input type="radio" name="question[3]" value="4" id="sanders3"> 
                   <label for="sanders3">Bernie Sanders</label>
                </li>
                <li>
			...
			<ul>
                ...
                <li>
                   <input type="radio" name="question[4]" value="2" id="cruz4">
                   <label for="cruz4">Ted Cruz</label>
                </li>
                <li>
                   <input type="radio" name="question[4]" value="3" id="kasich4"> 
                   <label for="kasich4">John Kasich</label>
                </li>
                <li>
                   <input type="radio" name="question[4]" value="4" id="sanders4"> 
                   <label for="sanders4">Bernie Sanders</label>
                </li>
                <li>
	        ...
	        <ul>
                ...
                <li>
                   <input type="radio" name="question[5]" value="2" id="cruz5">
                   <label for="cruz5">Ted Cruz</label>
                </li>
                <li>
                   <input type="radio" name="question[5]" value="3" id="kasich5"> 
                   <label for="kasich5">John Kasich</label>
                </li>
                <li>
                   <input type="radio" name="question[5]" value="4" id="sanders5"> 
                   <label for="sanders5">Bernie Sanders</label>
                </li>
                <li>
